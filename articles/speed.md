...
```
    ...
    List of 9
     ...
     $ metadata      :List of 5
      ...
      .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x5624c7c6e7a8>
...
```
    ...
    List of 9
     ...
     $ metadata      :List of 5
      ...
      .. .. ..$ swap            : chr "treatment"
      .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
      .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x5624c73fe418>
      .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
      .. .. ..$ adj_weight      : num 1
      .. .. ..$ bal_weight      : num 1
      .. .. ..$ iterations      : num 10000
...
```
    ...
    List of 9
     ...
     $ metadata      :List of 5
      ...
      .. .. ..$ swap            : chr "treatment"
      .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
      .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x5624c3ad5020>
      .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
      .. .. ..$ adj_weight      : num 1
      .. .. ..$ bal_weight      : num 1
      .. .. ..$ iterations      : num 10000
...
```
    ...
    List of 9
     ...
     $ metadata      :List of 5
      ...
      .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
      .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x5624c3a49ba8>
      .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
      .. .. ..$ adj_weight      : num 1
      .. .. ..$ bal_weight      : num 1
      .. .. ..$ iterations      : num 10000
