...
Note the final score of 100, made up of 100 for the whole plots, and 0 for the sub-plots. This shows that the algorithm has found a solution which has adjacencies between plots when looking at whole plot treatments which is impossible to avoid due to the split plot structure, but the sub-plots have been perfectly optimised.
