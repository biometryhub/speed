...
pa <- autoplot(factorial_design, treatments = "treatment_a") + labs(title = "Main effect A")
pb <- autoplot(factorial_design, treatments = "treatment_b") + labs(title = "Main effect B")
p <- autoplot(factorial_design) + labs(title = "Interaction")
