...
# Initialise data framecrd_design <- initialise_design_df(items = 8, nrows = 8, ncols = 4)head(crd_design)##   row col treatment
## 1   1   1        T1
## 2   2   1        T2
## 3   3   1        T3
## 4   4   1        T4
...
crd_result <- speed(crd_design, 
                    swap = "treatment",
                    seed = 42)## row and col are used as row and column, respectively.
...
##   .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x00000209da8a9d58> 
...
s <- summary(crd_result)s$per_level[[1]]$score## $initial
## [1] 40
## 
## $final
## [1] 2.285714
...
rcbd_design <- initialise_design_df(items = paste0("V", 1:6), nrows = 4, ncols = 6, block_nrows = 1, block_ncols = 6)head(rcbd_design)##   row col treatment row_block col_block block
## 1   1   1        V1         1         1     1
## 2   2   1        V1         2         1     2
## 3   3   1        V1         3         1     3
## 4   4   1        V1         4         1     4
...
##   .. .. ..$ swap            : chr "treatment"
##   .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
##   .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x00000209d39a3bd0> 
##   .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
##   .. .. ..$ adj_weight      : num 1
##   .. .. ..$ bal_weight      : num 1
##   .. .. ..$ iterations      : num 10000
...
latin_square_design <- initialise_design_df(items = 5, nrows = 5, ncols = 5)head(latin_square_design)##   row col treatment
## 1   1   1        T1
## 2   2   1        T2
## 3   3   1        T3
## 4   4   1        T4
...
##   .. .. ..$ swap            : chr "treatment"
##   .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
##   .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x00000209e2d165f0> 
##   .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
##   .. .. ..$ adj_weight      : num 1
##   .. .. ..$ bal_weight      : num 1
##   .. .. ..$ iterations      : num 10000
...
)split_plot_design <- initialise_split_design_df(splits = splits, rep_dim = c(4, 1))head(split_plot_design)##   row col block wholeplot wholeplot_treatment subplot subplot_treatment
## 1   1   1     1         1                   A       1                 a
## 2   2   1     1         2                   B       5                 a
## 3   3   1     1         3                   C       9                 a
## 4   4   1     2         4                   A      13                 a
...
)split_plot_result <- speed(split_plot_design, optimise = optimise, seed = 42)## row and col are used as row and column, respectively.
## Optimising level: wp 
...
##   .. .. ..$ spatial_factors :Class 'formula'  language ~row + col
##   .. .. .. .. ..- attr(*, ".Environment")=<environment: 0x00000209d3d6a5b0> 
##   .. .. ..$ spatial_cols    : chr [1:2] "row" "col"
##   .. .. ..$ adj_weight      : num 1
##   .. .. ..$ bal_weight      : num 1
##   .. .. ..$ iterations      : num 10000
