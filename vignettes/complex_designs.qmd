...
p1 <- autoplot(blocking_2d_design, block = "rowBlock", treatments = "rowBlock") + ggplot2::labs(title = "Row Blocks")
p2 <- autoplot(blocking_2d_design, block = "colBlock", treatments = "colBlock") + ggplot2::labs(title = "Column Blocks")
p3 <- autoplot(blocking_2d_design, block = "rowBlock") + ggplot2::labs(title = "Treatments")
p1 + p2 + p3 +
  plot_layout(ncol = 2) +
  plot_annotation(title = "Initial Row-Column Blocking Design")
```
...
blocking_2d_result <- speed(blocking_2d_design, 
                            ...
                            iterations = 150000,
                            early_stop_iterations = 50000, seed = 42)
```
