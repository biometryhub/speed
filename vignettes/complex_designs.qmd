...
#| echo: false
#| label: fig-prepplot2
#| fig-cap: "Initial layout of the p-rep design showing replicated treatments."
...
#| cache: true
optimize_params <- optim_params(swap_count = 5, swap_all_blocks = TRUE, adaptive_swaps = TRUE)
