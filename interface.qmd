...
2. Multi factor designs _with_ hierarchicy (e.g. split-plot, strip-plot, MET). These are more complex, and require a more flexible interface to specify the different levels of nesting and the relationships between them. These designs are partially supported in the current interface.
3. Multi factor designs _without_ hierarchicy (e.g. factorial designs with multiple factors that are crossed). These are also complex, and require a different approach to specifying the design. These designs are not currently supported in the package.
...
sp_params <- list(swap = list(wp = "wp_treatment",
                              sp = "sp_treatment", 
                              linked = TRUE),
                  swap_within = list(wp = "block",
                                     sp = "wholeplot", 
...
# or equivalently 
sp_params <- list(swap = list(wp = all("wp_treatment"),
                              sp = "sp_treatment", 
                              linked = TRUE),
                  swap_within = list(wp = "block",
                                     sp = "wholeplot", 
